...
function SkeletonItem() {
  return (
    <div className="flex items-start gap-3">
      <div className="animate-pulse w-4 h-3.5 bg-slate-200 dark:bg-slate-700 rounded mt-0.5 shrink-0" />
      <div className="flex-1 space-y-2">
        <div className="animate-pulse h-3.5 bg-slate-200 dark:bg-slate-700 rounded w-2/3" />
        <div className="animate-pulse h-1.5 bg-slate-200 dark:bg-slate-700 rounded" />
      </div>
    </div>
  );
}
